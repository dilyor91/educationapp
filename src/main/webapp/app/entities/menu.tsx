...
const EntitiesMenu = () => {
  return (
    <>
      {/* prettier-ignore */}
      <MenuItem icon="asterisk" to="/reg-instructuion">
        <Translate contentKey="global.menu.entities.regInstructuion" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/addmission-rules">
        <Translate contentKey="global.menu.entities.addmissionRules" />
      </MenuItem>
