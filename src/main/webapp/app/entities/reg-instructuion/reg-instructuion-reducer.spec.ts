...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGINSTRUCTUION_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGINSTRUCTUION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGINSTRUCTUION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGINSTRUCTUION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGINSTRUCTUION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGINSTRUCTUION actions', async () => {
      const expectedActions = [
        {
