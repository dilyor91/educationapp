...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDMISSIONRULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADDMISSIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADDMISSIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADDMISSIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADDMISSIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADDMISSIONRULES actions', async () => {
      const expectedActions = [
        {
