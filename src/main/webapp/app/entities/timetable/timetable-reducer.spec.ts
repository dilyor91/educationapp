...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './timetable.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMETABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIMETABLE actions', async () => {
      const expectedActions = [
        {
