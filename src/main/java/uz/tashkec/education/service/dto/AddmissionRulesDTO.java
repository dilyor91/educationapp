...
/**
 * A DTO for the {@link uz.tashkec.education.domain.AddmissionRules} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AddmissionRulesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmissionRulesDTO)) {
            return false;
        }

        AddmissionRulesDTO addmissionRulesDTO = (AddmissionRulesDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, addmissionRulesDTO.id);
    }
