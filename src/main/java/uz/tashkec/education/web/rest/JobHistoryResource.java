...
import uz.tashkec.education.repository.JobHistoryRepository;
import uz.tashkec.education.service.JobHistoryService;
import uz.tashkec.education.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.education.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
