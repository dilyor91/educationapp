...
import uz.tashkec.education.repository.DepartmentRepository;
import uz.tashkec.education.service.DepartmentService;
import uz.tashkec.education.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.education.domain.Department}.
 */
@RestController
@RequestMapping("/api")
