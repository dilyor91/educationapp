...
import uz.tashkec.education.domain.Employee;
import uz.tashkec.education.repository.EmployeeRepository;
import uz.tashkec.education.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.education.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
