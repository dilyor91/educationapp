...
import uz.tashkec.education.domain.Job;
import uz.tashkec.education.repository.JobRepository;
import uz.tashkec.education.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.education.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
