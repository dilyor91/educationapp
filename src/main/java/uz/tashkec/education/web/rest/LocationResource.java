...
import uz.tashkec.education.repository.LocationRepository;
import uz.tashkec.education.service.LocationService;
import uz.tashkec.education.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.education.domain.Location}.
 */
@RestController
@RequestMapping("/api")
