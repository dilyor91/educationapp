...
import uz.tashkec.education.repository.RegionRepository;
import uz.tashkec.education.service.RegionService;
import uz.tashkec.education.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.education.domain.Region}.
 */
@RestController
@RequestMapping("/api")
