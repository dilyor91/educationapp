 ...
 */
@Entity
@Table(name = "reg_instructuion")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class RegInstructuion implements Serializable {
    ...
    public RegInstructuion id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public RegInstructuion titleUz(String titleUz) {
    ...
    public RegInstructuion titleRu(String titleRu) {
    ...
    public RegInstructuion titleKr(String titleKr) {
    ...
    public RegInstructuion contentUz(String contentUz) {
    ...
    public RegInstructuion contentRu(String contentRu) {
    ...
    public RegInstructuion contentKr(String contentKr) {
    ...
    public RegInstructuion status(Boolean status) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegInstructuion)) {
            return false;
        }
        return id != null && id.equals(((RegInstructuion) o).id);
    }
