 ...
 */
@Entity
@Table(name = "addmission_rules")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AddmissionRules implements Serializable {
    ...
    public AddmissionRules id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public AddmissionRules titleUz(String titleUz) {
    ...
    public AddmissionRules titleRu(String titleRu) {
    ...
    public AddmissionRules titleKr(String titleKr) {
    ...
    public AddmissionRules contentUz(String contentUz) {
    ...
    public AddmissionRules contentRu(String contentRu) {
    ...
    public AddmissionRules contentKr(String contentKr) {
    ...
    public AddmissionRules status(Boolean status) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmissionRules)) {
            return false;
        }
        return id != null && id.equals(((AddmissionRules) o).id);
    }
